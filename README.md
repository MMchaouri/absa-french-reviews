...
|---|---|---|---|---|---|
| LLM zero-shot (Qwen3-1.7B) | — | — | — | — | — |
| LLM 3-shot (Qwen3-1.7B) | — | — | — | — | — |
| **CamemBERT fine-tuned** | ~85% | ~86% | ~85% | **~85.5%** | — |

> Fill in the LLM columns after running `python runproject.py --method=LLM --save_results=True`.
> Charts generated by `visualize.py` are in `confusion_matrices.png` and `comparison_chart.png`.
